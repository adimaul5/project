...
<![endif]-->
		...
		<script src="<?php echo base_url() . 'assets/public/themes/admin-lte/j-ui/jquery3.js'; ?>"></script>
		<script src="<?php echo base_url() . 'assets/public/themes/admin-lte/j-ui/jquery-ui.js'; ?>"></script>
		<script src="<?php echo base_url() . 'assets/public/themes/admin-lte/j-ui/datatablejs.js'; ?>"></script>
		<script src="<?php echo base_url() . 'assets/public/themes/admin-lte/DataTables/datatables.js'; ?>"></script>
		<script src="<?php echo base_url() . 'assets/public/themes/admin-lte/DataTables/datatables.min.js'; ?>"></script>	
