<?php $title = "<i class='fa fa-briefcase'></i>&nbsp;Armada"; ?>
<?php
$var = 'armada';
?>
...
<div class="widget-header">
    <h4 class="widget-title">Form Armada</h4>
...
<form class="form-horizontal" role="form" id="formAksi<?php echo $var; ?>">
  ...
  <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> No Polisi </label>
    <div class="col-sm-10">
      <input type="text" id="fc_nopol<?php echo $var; ?>" name="fc_nopol" placeholder="No Polisi" class="col-xs-10 col-sm-5" />
    </div>
  </div>
  <div class="form-group">
  <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Keterangan Armada </label>
    <div class="col-sm-10">
      <input type="text" id="fv_ket<?php echo $var; ?>" name="fv_ket" placeholder="Keterangan Armada" class="col-xs-10 col-sm-5" />
    </div>
  </div>
  <div class="form-group">
  <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Sopir </label>
    <div class="col-sm-10">
      <input type="text" id="fv_nama_sopir<?php echo $var; ?>" name="fv_nama_sopir" placeholder="Nama Sopir" class="col-xs-10 col-sm-5" />
    </div>
  </div>
