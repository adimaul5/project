<?php $title = "<i class='fa fa-briefcase'></i>&nbsp;Kandang Kecil"; ?>
<?php
$var = 'kandang';
?>
...
<div class="widget-header">
    <h4 class="widget-title">Form Kandang Kecil</h4>
...
<form class="form-horizontal" role="form" id="formAksi<?php echo $var; ?>">
  ...
  <div class="form-group">
  <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Jumlah Ayam </label>
    <div class="col-sm-10">
