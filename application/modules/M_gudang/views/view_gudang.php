<?php $title = "<i class='fa fa-briefcase'></i>&nbsp;Gudang"; ?>
<?php
$var = 'gudang';
?>
...
<form class="form-horizontal" role="form" id="formAksi<?php echo $var; ?>">
   <input type="hidden" name="fc_kdgudang" id="fc_kdgudang">
  <div class="form-group">
  <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Nama Gudang </label>
    <div class="col-sm-10">
      <input type="text" id="fv_nmgudang<?php echo $var; ?>" name="fv_nmgudang" placeholder="Nama Gudang" class="col-xs-10 col-sm-5" />
    </div>
  </div>
